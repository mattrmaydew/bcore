      ...
      <div class="container">
        ...
        <div class="intro h-100">
            <div class="row h-100 justify-content-center align-items-center">
              ...
              <div class="col-md-6">
                  <img src="/img/svg/products.svg" width="350" alt="" class="img-fluid">
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                      <tr v-for="product in products" :key="product.id">
                        ...
                        <td>
                          ...
                          <button style="margin-left: 3px" class="btn btn-danger" @click="deleteProduct(product)">Delete</button>
                        </td>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <div  class="d-flex">
                        <div class="p-1" v-for="(tag, index) in product.tags" :key="tag">
                          <div class="tag-wrapp" >  
                            <strong>{{tag}}</strong><span class="delete-tag" @click="deleteTag(tag, index)">X</span>
                          </div>  
                        </div>
...
.tag-wrapp span.delete-tag{
   margin-left: 4px;
}
.tag-wrapp span.delete-tag:hover{
  cursor: pointer;
}
