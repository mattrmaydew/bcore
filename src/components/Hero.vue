            ...
            <div class="col-md-5">
              <div class="hero-content" >
                ...
                <div class="hero-btn mt-5">
                    ...
                    <button class="btn custom-btn btn-secondary">Products</button>
                </div>
              </div>
            </div>
            <div class="col-md-7">
...
//    padding-top: 7rem;
    width: 100% ;
    height: 600px;
    background-image: url("/img/svg/attic2.jpg");
    background-position: center;
    background-repeat: no-repeat, repeat;
    border-left: 50px solid rgb(55, 107, 167);
    border-right: 50px solid rgb(55, 107, 167);
    border-bottom: 50px solid rgb(55, 107, 167);
  }
  .hero-content{
    color: #fdfbfb;
    text-align: left;
